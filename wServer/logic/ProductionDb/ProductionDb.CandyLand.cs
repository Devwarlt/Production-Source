    ...
    partial class BehaviorDb
    {
        ...
        .Init("MegaRototo",
            new State(
                ...
                new State("2",
                    new Shoot(10, 2, shootAngle: 10, projectileIndex: 2, coolDown: 200),
                    new Shoot(10, 1, projectileIndex: 3, coolDown: 200),
            ...
            .Init("Desire Troll",
                new State(
                    ...
                    new Shoot(15, 1, 0, angleOffset: 30 / 3, projectileIndex: 1, coolDown: 1000)
                ),
                new Threshold(0.01,
                    new TierLoot(6, ItemType.Weapon, 0.2),
                    new TierLoot(7, ItemType.Weapon, 0.1),
        ...
        .Init("Candyland Spawner",
            new State(
                ...
                new State("Unicorn",
                    ...
                    new TimedTransition(1000, "Monster Check")
                    ),
                new State("Cupcake",
