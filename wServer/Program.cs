...
namespace wServer
{
    internal static class Program
    {
        ...
        public static bool AutoBroadCastNews { get; private set; }
        ...
        {
            Console.Title = "Production Source - World Server";
            try
            {
                ...
                autoRestart = Settings.GetValue<bool>("autoRestart", "false");
                AutoBroadCastNews = Settings.GetValue<bool>("AutoBroadCastNews", "false");
                ...
                policy.Start();
                server.Start();
                if(Settings.GetValue<bool>("AutoBroadCastNews", "true") && File.Exists("news.txt"))
                    new Thread(autoBroadcastNews).Start();

                if (Settings.GetValue<bool>("autoRestart", "true"))
                    new Thread(autoRestartServer).Start();
        ...
        private static void autoRestartServer()
        {
